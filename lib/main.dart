          ...
          child: Padding(
            ...
            child: ListView(
              children: [
                ...
                Container(
                  color: const Color.fromARGB(255, 147, 87, 238),
                  child: const ListTile(
                    leading: CircleAvatar(child: Icon(Icons.star)),
                    title: Text('ListTile with Regular',
                        style: TextStyle(fontFamily: 'Roboto',fontSize: 25.0, fontWeight: FontWeight.normal, color: Colors.white)),
                ...
                Container(
                  ...
                  child: const ListTile(
                    ...
                    title: Text(
                      'ListTile with Bold',
                      style: TextStyle(fontFamily: 'Roboto',fontSize: 25.0,fontWeight: FontWeight.bold,color: Colors.white)),
                  ),
                ),
                ...
                Container(
                  ...
                  child: const ListTile(
                    ...
                    title: Text(
                      ...
                      style: TextStyle(fontFamily: 'Roboto',fontSize: 25.0,fontStyle: FontStyle.italic,color: Colors.white)),
                  ),
                ),
